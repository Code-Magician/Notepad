...
import 'package:my_app_1/utilities/dialogs/cannot_share_empty_note_dialog.dart';
import 'package:my_app_1/utilities/generics/get_arguments.dart';
...
class _NewNoteState extends State<NewNote> {
  ...
  Future<CloudNote> createNewOrGetExistingNote(BuildContext context) async {
    ...
    final newNote = await _notesService.createNote(ownerId: userId);
    _note = newNote;
    return newNote;
  }
